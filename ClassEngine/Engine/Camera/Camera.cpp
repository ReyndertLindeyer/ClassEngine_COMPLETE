...
Camera::Camera()
{
	...
	perspective = glm::perspective(fieldOfView, ClassEngine::GetInstance()->GetScreenSize().x / ClassEngine::GetInstance()->GetScreenSize().y, nearPlane, farPlane);
	orthographic = glm::ortho(0.0f, ClassEngine::GetInstance()->GetScreenSize().x, 0.0f, ClassEngine::GetInstance()->GetScreenSize().y, -1.0f, 1.0f);
